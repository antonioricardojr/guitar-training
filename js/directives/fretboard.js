            ...
            $( '.controls a.down' )
                .click( function ( ) {
                    ...
                    $( '.mask' )
                        .each( function ( ) {
                            var el = $( this );
                            var nextNote = el.find( 'li:nth-child(12)' )
                                .text( );

                            el.animate( { right: -268 }, slideSpeed );
                            setTimeout( function ( ) {
                                el.find( 'ul' )
                                    .prepend( "<li note=" + nextNote + ">" + nextNote + "</li>" );
                                el.find( 'li:last-child' )
                                    .remove( );
                                el.css( { right: -189 } );
                            }, slideSpeed + 20 )
                        } );
            ...
            $( '.controls a.up' )
                .click( function ( ) {
                    ...
                    $( '.mask' )
                        .each( function ( ) {
                            var el = $( this );
                            var nextNote = el.find( 'li:nth-child(2)' )
                                .text( );

                            $( "<li note=" + nextNote + ">" + nextNote + "</li>" )
                                .appendTo( el.find( 'ul' ) );
                            el.css( { right: -268 } );
                            el.find( 'li:first-child' )
                                .remove( );
                ...
                $( '.notes .mask' )
                    .each( function ( ) {
                        ...
                        var elClass = el.attr( 'class' )
                            .split( ' ' )[ 1 ];
                        var note = el.find( 'li:last-child' )
                            .text( );
